-- ARCHIVED: SQLite migration replaced by `add_proposals_tables.sql` (MySQL).
-- Original SQLite migration moved to `migrations/archived_sqlite_migrations/add_proposals_tables_sqlite.sql`.
