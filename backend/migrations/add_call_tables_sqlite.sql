-- ARCHIVED: SQLite migration replaced by `add_call_tables.sql` (MySQL).
-- Original SQLite migration moved to `migrations/archived_sqlite_migrations/add_call_tables_sqlite.sql`.
