-- ARCHIVED: SQLite migration replaced by `add_sms_tables.sql` (MySQL).
-- Original SQLite migration moved to `migrations/archived_sqlite_migrations/add_sms_tables_sqlite.sql`.
